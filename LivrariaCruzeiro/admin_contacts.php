...
<section class="messages">
   ...
   <div class="box">
      ...
      <a href="admin_contacts.php?delete=<?php echo $fetch_message['id']; ?>" onclick="return confirm('Deseja apagar esta mensagem?');" class="delete-btn">Deletar mensagem</a>
   </div>
   <?php
      };
   }else{
      echo '<p class="empty">Não possui mensagens!</p>';
   }
   ?>
   </div>
